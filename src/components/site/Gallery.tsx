      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <div className="mt-14 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
          {items.map((it, i) => (
            <figure
              key={i}
              className={`reveal group relative overflow-hidden rounded-2xl shadow-card hover-glow ${i === 0 ? "reveal-left" : "reveal-right"}`}
            ...
            >
              <img
                ...
                alt={it.alt}
                loading="lazy"
                className="h-[280px] sm:h-[400px] w-full object-cover transition-transform duration-[1.2s] group-hover:scale-105"
              />
